...
public class XListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		drawable.addFrame(getResources().getDrawable(R.drawable.loading1), 150);
		drawable.addFrame(getResources().getDrawable(R.drawable.loading2), 150);
		drawable.addFrame(getResources().getDrawable(R.drawable.loading3), 150);
		drawable.addFrame(getResources().getDrawable(R.drawable.loading4), 150);
		drawable.setOneShot(false);
		mProgressBar.setBackgroundResource(R.drawable.loading_bg);
